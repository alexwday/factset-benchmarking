...
monitored_institutions = {
    # Canadian Banks (7) - Using TSE exchange suffix for Toronto Stock Exchange
    ...
    # U.S. Banks (7) - Using US exchange suffix
    ...
    'JEF-US': {'name': 'Jefferies Financial Group Inc.', 'type': 'US_Banks'},
    
    # European Banks (14) - Using country-specific exchange suffixes
    'UBS-CH': {'name': 'UBS Group AG', 'type': 'European_Banks'},
    'BCS-GB': {'name': 'Barclays PLC', 'type': 'European_Banks'},
    ...
    'ING-NL': {'name': 'ING Groep N.V.', 'type': 'European_Banks'},
    'STAN-GB': {'name': 'Standard Chartered PLC', 'type': 'European_Banks'},
    'NWG-GB': {'name': 'NatWest Group plc', 'type': 'European_Banks'},
    ...
    'NYCB-US': {'name': 'New York Community Bancorp', 'type': 'US_Regionals'},
    ...
    'SCHW-US': {'name': 'Charles Schwab Corporation', 'type': 'US_Wealth_Asset_Managers'},
