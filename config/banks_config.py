...
monitored_institutions = {
    # Canadian Banks (7) - Try different ticker formats
    'RY': {'name': 'Royal Bank of Canada', 'type': 'Canadian_Banks'},
    'BMO': {'name': 'Bank of Montreal', 'type': 'Canadian_Banks'},
    'CM': {'name': 'Canadian Imperial Bank of Commerce', 'type': 'Canadian_Banks'},
    'NA': {'name': 'National Bank of Canada', 'type': 'Canadian_Banks'},
    'BNS': {'name': 'Bank of Nova Scotia', 'type': 'Canadian_Banks'},
    'TD': {'name': 'Toronto-Dominion Bank', 'type': 'Canadian_Banks'},
    'LB': {'name': 'Laurentian Bank', 'type': 'Canadian_Banks'},
    
    # U.S. Banks (7) - Simple tickers without suffix
    'JPM': {'name': 'JPMorgan Chase & Co.', 'type': 'US_Banks'},
    'BAC': {'name': 'Bank of America Corporation', 'type': 'US_Banks'},
    'WFC': {'name': 'Wells Fargo & Company', 'type': 'US_Banks'},
    'C': {'name': 'Citigroup Inc.', 'type': 'US_Banks'},
    'MS': {'name': 'Morgan Stanley', 'type': 'US_Banks'},
    'GS': {'name': 'Goldman Sachs Group Inc.', 'type': 'US_Banks'},
    'JEF': {'name': 'Jefferies Financial Group Inc.', 'type': 'US_Banks'},
    
    # Commenting out all other banks for now - uncomment and fix format once we confirm what works
